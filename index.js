...
console.log(homeTeamWinner[0]['Away Team Name'])

//(c) Home Team goals for 2014 world cup final
console.log(homeTeamWinner[0]['Home Team Goals'])

//(d) Away Team goals for 2014 world cup final
console.log(homeTeamWinner[0]['Away Team Goals'])

//(e) Winner of 2014 world cup final */
console.log(homeTeamWinner[0]['Win conditions'])
...
function getWinnersByYear(arr, getYearsCB, getWinnersCB) {
    ...
    return year.map(
      (i, index) => `In ${year[index]}, ${winner[index]} won the world cup!`
    );
  }
